...
public class CreateNodeCsr extends CreateNodeCertificateBase {
	...
	public void run() throws ToolException {
		...
		transportCsrFile = new File(getNodeFileName(nodeConfig) + ".csr");
		httpPrivateKeyFile = new File(getNodeFileName(nodeConfig) + "_http.key");
		httpCsrFile = new File(getNodeFileName(nodeConfig) + "_http.csr");
	...
	private void createTransportCsr() throws ToolException {
		try {
			...
			nodeResultConfig.setTransportPemTrustedCasFilePath("root-ca.pem"); // TODO
	...
	private void createHttpCsr() throws ToolException {
		try {
			...
			nodeResultConfig.setHttpPemTrustedCasFilePath("root-ca.pem");
