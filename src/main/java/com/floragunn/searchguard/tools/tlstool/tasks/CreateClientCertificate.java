...
public class CreateClientCertificate extends CreateClientCertificateBase {
	...
	public void run() throws ToolException {
		try {
			...
			File privateKeyFile = new File(ctx.getTargetDirectory(), getClientFileName(clientConfig) + "-key.pem");
			...
			if (isPasswordAutoGenerationEnabled(clientConfig.getPkPassword())) {
				appendOutputFile(readmeFile, createPasswordInfo(privateKeyPassword));
